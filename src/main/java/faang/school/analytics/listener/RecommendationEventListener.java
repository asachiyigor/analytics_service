...
@Slf4j
@Component
public class RecommendationEventListener extends
    AbstractEventListener<RecommendationEventDto> implements
    MessageListener {
  ...
  public void onMessage(Message message, byte[] pattern) {
    RecommendationEventDto eventDto = handleEvent(message, RecommendationEventDto.class);
    ...
    log.info("Event data received: {}", eventDto);
  }
}
